import hairOilImg from '../../../assets/redBananaHealth.jpg';
...
const HealthAndWealth = function () {
    const cardsData = [
    ...
    return(
        <div className="mt-20">
            <h2 className="text-green-600 text-center font-bold text-3xl">Health and Wellness</h2> 
            <p className="text-center mt-4">Strength You Can Taste. Wellness You Can Feel</p>
            <Swiper
                modules={[Pagination]}
                spaceBetween={20}
