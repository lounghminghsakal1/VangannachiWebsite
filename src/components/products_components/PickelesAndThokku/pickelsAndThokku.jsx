import hairOilImg from '../../../assets/prirandai.jpg';
...
const PicklesAndThoku = function () {
    const cardsData = [
        {id:1,name:"Pirandai Combo 2",price:"Rs. 1499.00",src:hairOilImg},
        {id:2,name:"Valaipoo Thokku Banana",price:"Rs. 430.00",src:hairOilImg},
        {id:3,name:"Pirandai Combo 1",price:"Rs. 3090.00",src:hairOilImg},
        {id:4,name:"Pirandai Thokku ",price:"Rs. 1590.00",src:hairOilImg},
    ];

    return(
        <div className="mt-20">
            <h2 className="text-green-600 text-center font-bold text-3xl">Pickles & Thokku</h2> 
            <p className="text-center mt-4">Spice Up Every Bite</p>
            <Swiper
                modules={[Pagination]}
                spaceBetween={20}
...
export default PicklesAndThoku;
